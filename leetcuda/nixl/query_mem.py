...
if __name__ == "__main__":
    ...
    temp_files = []
    for i in range(3):
        with tempfile.NamedTemporaryFile(dir="files_for_query", delete=False, suffix=f"_{i}.txt", mode="wb") as temp_file:
    ...
    try:
        ...
        # 1. Create an NIXL agent
        logger.info("Creating NIXL agent...")
        config = nixl_agent_config(enable_prog_thread=False, enable_listen_thread=False, backends=[])
        ...
        logger.info("-" * 50)
        # [{'mtime': '1759395177', 'mode': '33152', 'size': '23'}, {'mtime': '1759395177', 'mode': '33152', 'size': '23'}, None, {'mtime': '1759395177', 'mode': '33152', 'size': '23'}]
