...
class LookupClientFactory:
    ...
    def create_lookup_client(vllm_config: "VllmConfig", config: LMCacheEngineConfig) -> LookupClientInterface:
        ...
        if config.external_lookup_client is not None:
            ...
            # First Party
            from leetcuda.lmcache.lookup_client.lmcache_async_lookup_client import (
                LMCacheAsyncLookupClient,
            )
            from leetcuda.lmcache.lookup_client.lmcache_lookup_client import (
                LMCacheLookupClient,
            )
    ...
    @staticmethod
    def _create_external_lookup_client(external_lookup_uri: str, vllm_config: "VllmConfig") -> LookupClientInterface:
        """
        ...
        if scheme == "mooncakestore":
            return LookupClientFactory._create_mooncake_lookup_client(address, vllm_config)
        else:
